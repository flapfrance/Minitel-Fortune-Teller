...
# Füge die Werte von 0x20 bis 0x3F hinzu (entsprechend 0 - 31)
for i in range(0x20, 0x40):
    hex_value = hex(i)
    decimal_value = i - 0x20
    data.append([decimal_value, hex_value])

# Füge die Werte von 0x60 bis 0x7F hinzu (entsprechend 32 - 63)
for i in range(0x60, 0x80):
    hex_value = hex(i)
    decimal_value = i - 0x60 + 32
    data.append([decimal_value, hex_value])
...
[[0, '0x20'], [1, '0x21'], [2, '0x22'], [3, '0x23'], [4, '0x24'], [5, '0x25'],
